...
def home2():
    ...
    return render_template("home.html",name='chayakon')#,name = 'Tohn', fav = name)
    
if __name__ == "__main__":
    app.run('0.0.0.0',debug=True,port=5001)#host='0.0.0.0',port=5001